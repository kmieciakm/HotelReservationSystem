...
public:
    ...
    void DisplayStoreroomInfo(fort::char_table& table, std::string name, std::string area, std::string capacity, std::string occupied);
    void DisplayPaymentEvent();
    void DisplayBedroomReservationEvent();
    void DisplayConferanceRoomReservationEvent();
    void DisplayLoadEvent();
    void DisplayUnloadEvent();
    void DisplayReservationMenu();
    void DisplayStoreroomsMenu();
    void ClearScreen();
    void MainMenu();
};
